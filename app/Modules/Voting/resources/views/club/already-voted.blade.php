    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="relative rounded-3xl overflow-hidden shadow-xl">
            ...
            <div class="relative p-8 md:p-10 text-center text-white">
                <div
                    class="inline-flex w-20 h-20 rounded-3xl bg-white/15 backdrop-blur items-center justify-center text-5xl mb-4">
                    ✅
                </div>
                ...
                <div
                    class="mt-5 inline-flex items-center gap-2 rounded-2xl bg-white/10 backdrop-blur border border-white/20 px-4 py-2 text-sm">
        ...
        @if (optional($campaign->results_visibility)->value === 'announced')
            <a href="{{ route('public.results', $campaign->public_token) }}"
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="w-12 h-12 rounded-xl bg-white/20 backdrop-blur flex items-center justify-center text-2xl flex-shrink-0">
                        🏆</div>
                    ...
                    <span
                        class="opacity-70 group-hover:opacity-100 group-hover:translate-x-1 rtl:group-hover:-translate-x-1 transition text-xl">→</span>
                </div>
            </a>
        @else
            <div class="rounded-2xl border border-brand-200 bg-brand-50 p-5 text-sm text-brand-800 flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-brand-700 leading-7">
                        {{ __('Results will be announced by the committee once the campaign ends.') }}</p>
                </div>
            </div>
        @endif
